...
public class MainActivity extends Activity {
    private String initURL = "https://www.hello-algo.com";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.getSettings().setTextZoom(130); // where 150 is the percentage of font size
