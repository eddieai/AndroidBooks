package com.eddie.javascript_info;
...
public class MainActivity extends Activity {
    private String initURL = "https://zh.javascript.info";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.getSettings().setTextZoom(135); // where 150 is the percentage of font size
